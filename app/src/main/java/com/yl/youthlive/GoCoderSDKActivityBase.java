...
public abstract class GoCoderSDKActivityBase extends AppCompatActivity
        implements WZStatusCallback {

    private final static String TAG = GoCoderSDKActivityBase.class.getSimpleName();

    private static final String SDK_SAMPLE_APP_LICENSE_KEY = "GOSK-1545-0103-BA20-7D87-E572";
    ...
    public void syncPreferences() {
        ...
        mWZNetworkLogLevel = Integer.valueOf(prefs.getString("wz_debug_net_log_level", String.valueOf(WZLog.LOG_LEVEL_VERBOSE)));
